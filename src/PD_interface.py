    ...
    def create_obj(self, sliced_meshes_lst):
        ...
        for x in range(len(sliced_meshes_lst)):  # Parts별 obj생성
            ...
            for face in sliced_meshes_lst[x].faces:
                ...
                obj[x]['mesh'].append([sliced_meshes_lst[x].vertices[face[0]][0],
                                      sliced_meshes_lst[x].vertices[face[0]][1], sliced_meshes_lst[x].vertices[face[0]][2]])
                obj[x]['mesh'].append([sliced_meshes_lst[x].vertices[face[1]][0],
                                      sliced_meshes_lst[x].vertices[face[1]][1], sliced_meshes_lst[x].vertices[face[1]][2]])
                obj[x]['mesh'].append([sliced_meshes_lst[x].vertices[face[2]][0],
                                      sliced_meshes_lst[x].vertices[face[2]][1], sliced_meshes_lst[x].vertices[face[2]][2]])
